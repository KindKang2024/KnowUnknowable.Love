  ...
  a && Object.deepExtend(i, a),
    ...
    i.fn.retinaInit = function () {
      i.retina_detect && window.devicePixelRatio > 1
        ...
        i.interactivity.modes.grab.distance = i.tmp.obj.mode_grab_distance *
          i.canvas.pxratio,
        i.interactivity.modes.bubble.distance = i.tmp.obj.mode_bubble_distance *
          i.canvas.pxratio,
      ...
      i.canvas.el.width = i.canvas.w,
        ...
        window.addEventListener("resize", function () {
          i.canvas.w = i.canvas.el.offsetWidth,
            ...
            i.tmp.retina &&
            (i.canvas.w *= i.canvas.pxratio, i.canvas.h *= i.canvas.pxratio),
            i.canvas.el.width = i.canvas.w,
            i.canvas.el.height = i.canvas.h,
    ...
    i.fn.particle = function (e, a, t) {
      if (
        ...
        } else {void 0 != e.value.r && void 0 != e.value.g &&
            void 0 != e.value.b &&
            (this.color.rgb = { r: e.value.r, g: e.value.g, b: e.value.b }),
            void 0 != e.value.h && void 0 != e.value.s && void 0 != e.value.l &&
    ...
    i.fn.particle.prototype.draw = function () {
      ...
      if (a.color.rgb) {
        var n = "rgba(" + a.color.rgb.r + "," + a.color.rgb.g + "," +
          a.color.rgb.b + "," + s + ")";
      } else {var n = "hsla(" + a.color.hsl.h + "," + a.color.hsl.s + "%," +
          a.color.hsl.l + "%," + s + ")";}
    ...
    i.fn.particlesUpdate = function () {
      for (var e = 0; e < i.particles.array.length; e++) {
        ...
        if (
          i.particles.opacity.anim.enable && (1 == a.opacity_status
            ...
            i.particles.size.anim.enable && (1 == a.size_status
    ...
    i.fn.interact.linkParticles = function (e, a) {
      ...
      if (n <= i.particles.line_linked.distance) {
        var r = i.particles.line_linked.opacity -
          n / (1 / i.particles.line_linked.opacity) /
    ...
    i.fn.modes.pushParticles = function (e, a) {
      ...
      for (var t = 0; e > t; t++) {
        i.particles.array.push(
          ...
          t == e - 1 &&
          (i.particles.move.enable || i.fn.particlesDraw(), i.tmp.pushing = !1);
      }
    },
      ...
      if (
          ...
          if (c >= 0 && "mousemove" == i.interactivity.status) {
            ...
            if (
              ...
              if (
                ...
                v > e.opacity && v <= i.interactivity.modes.bubble.opacity &&
                  (e.opacity_bubble = v);
              } else {
                var v = e.opacity -
                  (i.particles.opacity.value -
        ...
        if (i.tmp.bubble_clicking) {
          var s = e.x - i.interactivity.mouse.click_pos_x,
            ...
            r = Math.sqrt(s * s + n * n),
            p = ((new Date()).getTime() - i.interactivity.mouse.click_time) /
              1e3;
      ...
      if (
        ...
        if (
          ...
          (i.tmp.repulse_count++,
            ...
            (i.tmp.repulse_finish = !0)), i.tmp.repulse_clicking
        ) {
      ...
      if (
        ...
        if (s <= i.interactivity.modes.grab.distance) {
          var n = i.interactivity.modes.grab.line_linked.opacity -
            s / (1 / i.interactivity.modes.grab.line_linked.opacity) /
    ...
    i.fn.vendors.createSvgImg = function (e) {
      var a = i.tmp.source_svg,
        ...
        s = a.replace(t, function (a, t, i, s) {
          if (e.color.rgb) {
            var n = "rgba(" + e.color.rgb.r + "," + e.color.rgb.g + "," +
              e.color.rgb.b + "," + e.opacity + ")";
          } else {var n = "hsla(" + e.color.hsl.h + "," + e.color.hsl.s + "%," +
